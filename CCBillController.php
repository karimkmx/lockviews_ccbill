...
class CCBillController extends Controller
{
   ...
   */
    ...
    $plan = $user->plans()
      ...
      // Base url
      $baseURL = 'https://sandbox-api.ccbill.com/wap-frontflex/flexforms/' . $payment->ccbill_flexid;
    ...
    public function cancelSubscription($id)
    {
        ...
        $payment = PaymentGateways::whereName('CCBill')->firstOrFail();
          ...
          $inputs['clientAccnum']    = $payment->ccbill_accnum;
          $inputs['clientSubacc']    = $payment->ccbill_subacc;
          $inputs['subscriptionId']    = $subscr_id;
          //$input['timestamp']    = "";
          $inputs['reason']    =  "Client Cancelled The Subscription";
          $inputs['source']    = "API";
          $inputs['action']    = "cancelSubscription";
          $inputs['username']    = "lock1234";
          $inputs['password']    = "LOckviews@123@";



          // Base url
      $baseURL = 'https://datalink.ccbill.com/utils/subscriptionManagement.cgi';

        // Build redirect url
        $inputss = http_build_query($inputs);
        $redirectUrl = $baseURL . '?' . $inputss;
